...
class GameControl:
    '''This is the top level class that control the game,
        using the classes: UserInterface and Statististics.'''

    def __init__(self):
        '''Constructs two objects of type UserInterface and Statistics.'''
...
class Statististics(Cards):
    '''This class  keeps  track of the number of wins and losses.
        And also display this information. Also receives inf from the class Cards.'''
